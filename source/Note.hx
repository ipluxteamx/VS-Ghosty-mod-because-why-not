...
class Note extends FlxSprite
{
	...
	public var noteKind:String = "normal";
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inCharter:Bool = false, ?isAlt:Bool = false, ?bet:Float = 0, noteKind:String = "normal")
	{
		super();
		...
		else
		{
			...
			switch (noteTypeCheck)
			{
				case 'pixel':
					...
					updateHitbox();
				default:
					//i am going fucking insane why doesn't tHIS WORK-
